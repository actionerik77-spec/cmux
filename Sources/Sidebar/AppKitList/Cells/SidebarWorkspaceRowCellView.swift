...
#endif
        // Select the field editor directly after focus. Calling selectText(_:)
        // on the control re-enters the field-editor session and can commit the
        // unchanged title; selecting the editor preserves the active session.
