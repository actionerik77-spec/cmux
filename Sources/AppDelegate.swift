...
final class AppDelegate: NSObject, NSApplicationDelegate, UNUserNotificationCenterDelegate, NSMenuItemValidation, NSMenuDelegate, CmuxConfigStoreReloadEnvironment {
    ...
    private func removeMainWindowContext(
        ...
        // Cancel any in-flight workspace handoff before detaching or retiring
        // the context's owned terminal graph. A pending handoff retains frame
        // observers and renderer protection until it is explicitly canceled.
